<%-- 
    Document   : tablePage
    Created on : 17-Feb-2018, 10:18:24
    Author     : DEXTER
--%>
...
<html>
    ...
    <body class="bodyClass5">
        ...
        <div style="text-align: center; margin-top: 20px; margin-bottom: 15px;">
            <form:form enctype="multipart/form-data" method="POST" action="blogcommentary" commandName="fourteenthBeanObject">
                <p style="color: red; font-size: 20px;">${commentaryimage}</p>
                <form:hidden path="spare" value="${pg}"/>
                <form:hidden path="id" value="${n}"/>
                <form:hidden path="page" value="${pgn}"/>
                <form:hidden path="table" value="${t}"/>
            ...
            <div class="commentBack">
                <a href="rdr?pg=${pg}&n=${n}&pgn=${pgn}&t=${t}">Back</a>
            </div>
        </div>
