<%-- 
    Document   : quotePage
    Created on : 23-Jan-2018, 22:38:47
    Author     : DEXTER
--%>
    ...
    <body class="bodyClass5">            
        ...
        <div style="text-align: center; margin-top: 5px; margin-bottom: 5px;">
            <form:form enctype="multipart/form-data" method="POST" action="submitQuote" commandName="fourteenthBeanObject">
                ...
                <form:hidden path="space" placeholder="Content" cols="100" rows="20"/>
                Edit statement:<br>
                <form:textarea id="txt_Area_InformAll2" path="newsPost2" placeholder="Quoted text" cols="90" rows="15"/><br><br>
                <form:textarea path="check" cols="90" rows="20" style="display: none;"/>
                Write a comment/reaction in the box below:<br>
                <form:textarea id="txt_Area_InformAll" path="newsPost" placeholder="Content" cols="90" rows="15"/><br><br>
