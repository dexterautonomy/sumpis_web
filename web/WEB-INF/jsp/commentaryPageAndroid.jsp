<%-- 
    Document   : commentaryPageAndroid
    Created on : 07-May-2018, 23:13:37
    Author     : DEXTER
--%>
...
<html>
    ...
    <body class="bodyClass5">            
        ...
        <div style="text-align: center; margin-top: 40px; margin-bottom: 15px;">
            <form method="POST" action="androidSubmitCommentary">                
                ...
                <textarea style="font-size: 18px;" id="txt_Area_InformAll" name="comment" placeholder="Comment" cols="90" rows="20"></textarea><br><br>
            ...
            <div style="font-size: 20px; margin-top: 30px;">
                <a href="andwx?news=${headline}&date=${date}&id=${id}&pgn=${pgn}&username=${username}">Back</a>
            </div>
        </div>
    </body>
</html>